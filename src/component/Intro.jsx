        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 ' >
            ...
            min-h-screen text-black flex justify-center items-center p-6 brightness-100'>
                    ...
                    <div className="flex flex-col justify-center gap-12 h-96">
                        ...
                        <a  >
                            <Link to="contact"
                                ...
                                duration={500}
                                offset={-70}
                                className='px-24 py-4 bg-white text-black border border-black border-solid 
                ...
                <div className='absolute bottom-10 lg:bottom-20 left-10 text-center p-4'>
                    ...
                    <a href="https://drive.google.com/file/d/1hiDRIJ8M5KHieWoaZssoPdLfpcPCagv-/view?usp=sharing"
                        target='_blank'
